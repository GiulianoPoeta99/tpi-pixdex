...
export const FilterModal: React.FC<FilterModalProps> = ({
    ...
    const [selectedTypes, setSelectedTypes] = React.useState<number[]>(activeFilters.types);
    const [selectedGenres, setSelectedGenres] = React.useState<number[]>(activeFilters.genres);
            ...
            <View style={styles.centeredView}>
                <View style={styles.modalView}>
                    <View style={styles.header}>
                        <TextPressStart2P style={styles.modalTitle}>Filter Content</TextPressStart2P>
                    ...
                    <View style={styles.footer}>
                        ...
                        <Button onPress={handleApply} text="APPLY FILTERS" icon="check-circle" />
                    </View>
                </View>
            </View>
        </Modal>
